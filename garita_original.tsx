  ...
  return (
    <>
      ...
      <div className="flex-1 p-6 flex flex-col min-h-0 bg-slate-50 print:hidden">
        <div className="max-w-7xl mx-auto flex flex-col flex-1 min-h-0 w-full space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-lg shadow-sm flex-1 min-h-0 overflow-auto">
